...
{ 
  ...
  {"S34ML01G100TF100", {0x01, 0xF1, 0x00, 0x1D, 0x01}, 2048, 64, 64, S34},  
    ...
    while ((opt = getopt(argc, argv, "c:p:e:E:s:r:w:W:R:f:v")) != -1) {		//: semicolon means that option need an arg!
      switch(opt) {
        ...
        default:
          ...
          printf("./bitbang_ft232 -f eripv2.bin -s 64 -w 64\n");
          printf("./bitbang_ft232 -f eripv2.bin -s 64 -r 64\n");

          printf("Write on third eraseblock 0x40000-0x80000 (rawstorage, keys) of 128 * 2048 pages -> 256 kB\n");
          printf("./bitbang_ft232 -p 2 -e 2\n");
          printf("./bitbang_ft232 -f rawstorage.bin -s 128 -r 128\n");
