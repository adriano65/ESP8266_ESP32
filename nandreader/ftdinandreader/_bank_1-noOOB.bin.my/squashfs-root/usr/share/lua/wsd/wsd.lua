local pairs, ipairs, pcall, loadstring, string, type, trace, mbus, require = 
      pairs, ipairs, pcall, loadstring, string, type, trace, mbus, require
...
local function loc_invoke(cmd, type, path, allok) 
   ...
   if not ok or err then
      ...
      if tprint then
         trace('E - '..msg)
         if res then trace('res =') tprint(res) end
         if err then trace('err =') tprint(err) end
      end
   end
   return allok, msg
end
